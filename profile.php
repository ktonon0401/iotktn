    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container">
                <div class="card">
                    <img src="giabao.jpg"   alt="">
                    <p>Nguyen Gia Bao </p>
                    <p>19146083 </p>
                </div>
                <div class="card" style="margin-left: 560px;">
                    <img width="285px" src="hongbao.jpg"  alt="">
                    <p>Phan Hong Bao </p>
                    <p>191444051 </p>                    
                </div>
                <div class="card" style="margin-left: 1000px;">
                    <img width="310px" style="border-style: solid;" src="quangminh.png" alt="">
                    <p>Vo Quang Minh </p>
                    <p>19146...</p>
                </div>
            </div>
